...
} = require("../schema/validateSchema.js");
...
const updateContact = async (req, res) => {
  ...
  const result = await Contact.findOneAndUpdate({ _id: contactId }, value, {
...
const updateStatusContact = async (req, res) => {
  ...
  const result = await Contact.findByIdAndUpdate({ _id: contactId }, value, {
    returnOriginal: false,
  });
  if (result) {
    res.json(result);
